...
import com.company.springproject.dal.Payment;
...
public class PaymentController {
    private final CommonRepository<Payment> repository;

    @PostMapping
    public ResponseEntity<Integer> add(@RequestBody Payment entity){
        return ResponseEntity.ok(repository.save(entity).Id);
    }

    @GetMapping
    public ResponseEntity<Payment> get(@RequestParam Integer entityId){
    ...
    @PatchMapping()
    public ResponseEntity<Integer> update(@RequestBody Payment entity){
